...
require (
	...
	github.com/mariopetricevic/plugins v0.0.0-20230530183827-508b0ce1a348 // indirect
	github.com/mariopetricevic/plugins2 v0.0.0-20230501092545-66b2ef3f9639 // indirect
